...
class Register extends React.Component {
    ...
    checkPasswords() {
        if (this.passwordLength() === true && this.passwordMatch() === true) {
            return true
        }
        else {
            return false
    ...
    registerUser() {
        ...
        if (this.checkPasswords() === true) {
            ...
            alert("Password Parameters Not Met")    
        }
        else {
            return null
        }
                ...
                <div style={{marginTop: 100}} >
                    <form data-toggle="Validator" role="form"  >
                        ...
                        <div className="form-group" >
                            ...
                            <div className="help-block"> {this.checkLength(this)} </div>
                        </div>
                        ...
                        <div className="form-group" >
                            ...
                            <div className="help-block with-errors"> {this.checkMatch(this)} </div>
                        </div>
